            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>$1,200.00</td>
                        <td>
                            <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#viewOrderModal">Ver</button>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h5>ID de Orden: 1001</h5>
                        <p><strong>Proveedor:</strong> Proveedor X</p>
                        <p><strong>Fecha de Orden:</strong> 2024-08-01</p>
